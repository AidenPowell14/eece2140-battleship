 ...
 * if they have been struck, or NONE if they haven't been yet. Non-null points cannot be
 * struck again.
 */
class HitBoard {
    public:
     ...
     * has been fired here, return NONE.
     * 
     ...
     * @throws std::invalid_argument if the point does not exist, or the status is NONE
     */
